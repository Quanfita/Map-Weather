...
public class AddressToLatitudeLongitude {
    ...
    public void getLatAndLngByAddress(){
        ...
        String url = String.format("http://api.map.baidu.com/geocoder/v2/?"
                +"address=%s&ak=yDkwa44cN74B8Gq6DpwbOjvghKhUxGhW&output=json&mcode=08:C9:CB:34:5D:EA:4E:DB:B2:FA:C6:37:43:05:AD:07:A3:3D:D4:B2;com.example.baidu.map",addr);
        URL myURL = null;
    ...
    public static void main(String[] args) {
    		AddressToLatitudeLongitude at = new AddressToLatitudeLongitude("河北省石家庄市河北科技大学");
